"""
Training script for VGG models on CIFAR-100 with integrated MI evaluation.

Trains VGG models (9, 11, 13, 16, 19) with Global Average Pooling and evaluates
...
def main():
    parser = argparse.ArgumentParser(description='Train VGG on CIFAR-100 with MI evaluation')
